...
// Only the following getSite() implementation follows the BSD license declared above.
// This code just provides a ES module bridge to call CommonJS style module from the Extension.
export function getSite(url) {
    return psl.get(url);
}

// Following minimized code is from https://github.com/lupomontero/psl/blob/main/dist/psl.min.js
// and follows MIT license. See https://github.com/lupomontero/psl/blob/main/LICENSE.
